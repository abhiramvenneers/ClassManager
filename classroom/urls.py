...
urlpatterns =[
    ...
    path('student/<int:pk>/all_marks',views.StudentAllMarksList.as_view(),name="student_all_marks_list"),
    ...
    path('add_viva_mark/<int:pk>/', views.add_viva_mark, name='add_viva_mark'),
    path('add_assignment_mark/<int:pk>/', views.add_assignment_mark, name='add_assignment_mark'),
]
